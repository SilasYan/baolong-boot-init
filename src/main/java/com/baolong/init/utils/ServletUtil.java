package com.baolong.init.utils;
...
public class ServletUtil {
	...
	public static String getIp(HttpServletRequest request) {
		...
		if (ip == null) ip = checkHeaderForIp(request, X_REQUESTED_FOR);
		if (ip == null) ip = checkHeaderForIp(request, PROXY_CLIENT_IP);
		if (ip == null) ip = checkHeaderForIp(request, WL_PROXY_CLIENT_IP);
		if (ip == null) ip = checkHeaderForIp(request, HTTP_CLIENT_IP);
		if (ip == null) ip = checkHeaderForIp(request, HTTP_X_FORWARDED_FOR);
